...
const vTop = (status, cls = '') => `<div class="nav"><span class="back">${I.chev} Inbox</span><div class="title"><span class="titlemenu">Home lab ${I.chev}</span></div><span class="modebtn">${I.compose}</span></div>
