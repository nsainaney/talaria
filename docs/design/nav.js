...
const C = [
  ...
  phone('3 · A chat <small>· waveform switches this chat to voice</small>', `<div class="nav"><span class="back">${I.chev} Inbox</span><div class="title">Home lab</div><div class="group"><span class="iconbtn sm">${I.gear}</span><span class="modebtn">${I.wave}</span></div></div>${chatBody}${composer()}`),
  phone('4 · Chat settings <small>· gear: skills, model, pin, delete; tap the title to rename</small>', `<div class="nav"><span class="back">${I.chev} Inbox</span><div class="title">Home lab</div><div class="group"><span class="iconbtn sm on">${I.gear}</span><span class="modebtn">${I.wave}</span></div></div>${chatBody}${composer()}${menu}`),
...
const vTop = (status, cls = '') => `<div class="nav"><span class="back">${I.chev} Inbox</span><div class="title">Home lab</div><div class="group"><span class="iconbtn sm">${I.gear}</span><span class="modebtn">${I.compose}</span></div></div>
